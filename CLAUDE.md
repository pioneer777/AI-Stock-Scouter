...
점수 조건 (5개 × 20점):
  - SMA20이 SMA60을 상향돌파 (최근 5일 내, 신선도 점수)
  - RSI 50~69 (상승 모멘텀)
...
```
대전제: 현재가 < 30일 고점 × 97% (최소 3% 눌린 상태 확인)

하드게이트:
  - 현재가 ≥ 30일 최고가 × 97% (아직 눌림 없음 = 고점 부근)  ← 신규
...
### 대형주 / 중소형주 기준 분리
```
대형주 (시총 1조+): 거래량 기준 20일 평균 120% 이상
...
*마지막 업데이트: 2026-04-26*
*버전: V2.1 (그랜드 SMA200 바닥권 게이트 / 골든 눌림 확인 게이트 / test.yml clear_history / Naver 주말 날짜 파라미터)*
